...
原创肩后视角生存动作 Web 3D 原型，验证移动、瞄准、射击、近战、敌人波次与资源管理手感。

simuRE 是一个面向浏览器的原创生存动作游戏原型。当前重点不是堆内容量，而是把第一轮“能动、能瞄、能打、敌人有压迫感、资源有压力”的核心循环做顺手。
...
- 肩后视角摄像机、键盘移动、鼠标准心、右键拖动视角、射击、装填、近战和闪避。
- 敌人逐波生成、追击玩家、近身攻击，可被射击或近战击退消灭。
